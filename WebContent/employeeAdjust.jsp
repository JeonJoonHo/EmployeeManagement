...
<%
	...
	emp = dbs.dbEmployeeView(Integer.parseInt(id));
%>
<!DOCTYPE html>
<html lang="ko">
<head>
...
<body>
	<div id="em-container">
		...
		<%
			while (emp.next()) {
		%>
		<form action="updateEmployee.jsp?page=<%=emp.getInt("em_num") %>" method="post">
			<div id="em-add-content">
					...
					<div class="panel-body" id="em-inner-body">
						...
						<div class="form-group">
							<label class="control-label" for="inputDefault"> 입사 일자 </label> <input
								...
								value=<%=emp.getString("em_join")%> disabled="">
						</div>
						...
						<div class="form-group">
							<label class="control-label" for="inputDefault"> 부서 </label> <select
								name="em_part" id="em_part">
								<%
									while (part.next()) {
								%>
				...
				<div id="em-inside-right">
					<div class="panel panel-success">
						...
						<div class="panel-body" id="em-inner-body"></div>
					</div>
